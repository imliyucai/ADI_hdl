...
axi_ad7771_if i_ad7771_if (
  ...
  .adc_crc_s_0_1_ila(adc_crc_s_0_1_ila),
  .adc_crc_s_2_3_ila(adc_crc_s_2_3_ila),
  .adc_crc_s_4_5_ila(adc_crc_s_4_5_ila),
  .adc_crc_s_6_7_ila(adc_crc_s_6_7_ila),
  .adc_crc_read_data_0_1_ila(adc_crc_read_data_0_1_ila),
  .adc_crc_read_data_2_3_ila(adc_crc_read_data_2_3_ila),
  .adc_crc_read_data_4_5_ila(adc_crc_read_data_4_5_ila),
  .adc_crc_read_data_6_7_ila(adc_crc_read_data_6_7_ila),
  .adc_crc_mismatch_s_0_1_ila(adc_crc_mismatch_s_0_1_ila),
  .adc_crc_mismatch_s_2_3_ila(adc_crc_mismatch_s_2_3_ila),
  .adc_crc_mismatch_s_4_5_ila(adc_crc_mismatch_s_4_5_ila),
  .adc_crc_mismatch_s_6_7_ila(adc_crc_mismatch_s_6_7_ila),
  .adc_crc_ch_mismatch(adc_crc_ch_mismatch),
